...
let i_61 = document.querySelector('.i-61');
let i_62 = document.querySelector('.i-62');
function f6() {
    let a = i_61.value;
    let b = i_62.value;
    for (let key in a6) {
...
let input_9 = document.querySelector('.i-9');
function f9() {
    let out = '';
    let a = +input_9.value;
    for (let key in a9) {
...
let input_19 = document.querySelector('.i-19');
function f19() {
    let out = '';
    let a = input_19.value;
    for (let key in a19) {
        for (let k = 0; k < a19[key].length; k++) {
            if (a.toLowerCase() == a19[key][k].toLowerCase()) {
                out = key;
                break;
            }
