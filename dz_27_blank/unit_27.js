...
function t2() {
    let a = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=1&num2=14')
            .then(data => {
                resolve(data.text());
            });
    });
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=2&num2=9')
            .then(data => {
                resolve(data.text());
            });
    });
...
function t3() {
    ...
    let b = new Promise((resolve, reject) => {
        fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=3&num2=19')
            .then(data => {
                resolve(data.text());
            });
    });
