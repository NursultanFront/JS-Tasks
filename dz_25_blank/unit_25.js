...
function t2() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Nursultan', true);
    xhttp.send();
    function myFunc(data) {
        console.log(data);
...
function t3() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=3&num2=5', true);
    xhttp.send();
    function myFunc(data) {
        console.log(data);
...
function t4() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=1&num2=5', true);
    xhttp.send();
    function myFunc(data) {
        console.log(data);
...
function t6() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=122&num2=10', true);
    xhttp.send();
    function myFunc(data) {
        console.log(data);
...
function t8() {
    ...
    xhttp.open('GET', 'http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1995', true);
    xhttp.send();
    function myFunc(data) {
        console.log(data);
...
function t10() {
    ...
    xhttp.send('auth=5ADcB96BA48d3f80&action=10');
    function myFunc(data) {
        console.log(data);
...
function t11() {
    ...
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=2&name=Nursultan');
    function myFunc(data) {
        console.log(data);
...
function t12() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=3&num1=8&num2=5');
    function myFunc(data) {
        console.log(data);
...
function t13() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=4&num1=1&num2=7');
    function myFunc(data) {
        console.log(data);
...
function t15() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=6&num1=3&num2=5');
    function myFunc(data) {
        console.log(data);
...
function t17() {
    ...
    xhttp.open('POST', 'http://getpost.itgid.info/index2.php', true);
    xhttp.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    xhttp.send('auth=5ADcB96BA48d3f80&action=8&year=1995');
    function myFunc(data) {
        console.log(data);
