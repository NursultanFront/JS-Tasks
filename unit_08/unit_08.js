...
//     4 5 6 7 8
// Задача решается с помощью цикла  while.
let i_81 = document.querySelector('.i-81');
let i_82 = document.querySelector('.i-82');
function t8() {
    let a = +i_81.value;
    let b = +i_82.value;
    let out = '';
...
let i_91 = document.querySelector('.i-91');
let i_92 = document.querySelector('.i-92');
function t9() {
    let a = +i_91.value;
    let b = +i_92.value;
    let out = '';
...
function t11() {
    let out = '';
    let k = 0
    while (k < div_11.length) {
        out += div_11[k].innerHTML + ' ';
        k++
    }
...
function t12() {
    let k = 0
    while (k < div_12.length) {
        div_12[k].style.background = 'orange';
        k++
    }
}
