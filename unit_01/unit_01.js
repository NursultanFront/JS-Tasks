...
document.getElementById('two').textContent = 12 * 12;
...
document.querySelector('.three').innerHTML = '<h3>Heloooooo</h3>';
...
document.querySelector('.four').innerHTML += '<h4>Wooooorld</h4><p>Hey whats up??</p>';
...
// console.log(divS3);
// Identifier 'divS3' has already been declared -----переменная уже используется!!!
// Task 20
