...
//
let input_6 = document.querySelector('.i-6')
function t6() {
    let out = '';
    let a = +input_6.value;
    for (let i = a; i > 0; i--) {
...
//     4 5 6 7 8
// Задача решается с помощью цикла.
let input_81 = document.querySelector('.i-81');
let input_82 = document.querySelector('.i-82');
function t8() {
    let a = +input_81.value;
    let b = +input_82.value;
    let out = '';
    for (let i = a; i <= b; i++) {
        out += i + ' '
    }
...
// цикл - один
let input_91 = document.querySelector('.i-91');
let input_92 = document.querySelector('.i-92');
function t9() {
    let out = '';
    let a = +input_91.value;
    let b = +input_92.value;
    if (a > b) {
        [a, b] = [b, a];
    }
    for (let i = a; i <= b; i++) {
...
let div_11 = document.querySelectorAll('.div-11'); //как лучше??? Что бы перенную объявить в самой функции или вне ее????
function t11() {
    let out = '';
    for (let i = 0; i < div_11.length; i++) {
        out += div_11[i].innerHTML + ' ';
    }
...
let input_14 = document.querySelectorAll('.i-14');
function t14() {
    for (let i = 0; i < input_14.length; i++) {
        if (input_14[i].checked) {
            document.querySelector('.out-14').textContent = input_14[i].value
        }
    }
}
