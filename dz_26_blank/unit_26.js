...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=2&name=Nursultan')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=3&num1=3&num2=8')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=4&num1=3&num2=8')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=6&num1=3&num2=15')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=5ADcB96BA48d3f80&action=8&year=1995')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t11() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=2&name=Nursultan',
    })
        .then(data => {
            return data.text();
        })
...
function t17() {
    fetch('http://getpost.itgid.info/index2.php', {
        ...
        body: 'auth=5ADcB96BA48d3f80&action=8&year=1995',
    })
        .then(data => {
            return data.text();
        })
