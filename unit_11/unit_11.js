...
let input_1 = document.querySelector('.i-1');
function f1() {
    /**
     * ваш код здесь
     */
    d1.push(input_1.value)
    showArr('.out-1', d1);
}
...
// Вывод в out-11
let input_11 = document.querySelector('.i-11');
let d11 = [2, 3, 4, 5, 6, 7];

function f11() {
    let a = +input_11.value;
...
// Вывод в out-12
let input_12 = document.querySelector('.i-12');
let d12 = [6, 62, 60, 70, 1, 5];

function f12() {
    let a = +input_12.value;
    let out = -1;
...
let input_18 = document.querySelector('.i-18');
function f18() {
    document.querySelector('.out-18').textContent = d18.includes(input_18.value);
}
