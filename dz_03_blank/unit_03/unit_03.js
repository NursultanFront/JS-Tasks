...
let inputIn1 = document.querySelector('.i-1');
function f1() {
    if (inputIn1.value == 4) {
...
let inputIn_31 = document.querySelector('.i-31');
let inputIn_32 = document.querySelector('.i-32');
function f3() {
    let a = +inputIn_31.value
    let b = +inputIn_32.value
    if (a > b) {
...
let inputIn_4 = document.querySelector('.i-4');

function f4() {
    let a = +inputIn_4.value;
    let b = 2020 - a;
    if (b >= 18) {
...
let inputIn_5 = document.querySelector('.i-5');
function f5() {
    let a = +inputIn_5.value
    if (a < 0) {
...
let inputIn_6 = document.querySelector('.i-6')
function f6() {
    let a = +inputIn_6.value;
    if (a % 2 == 0) {
...
let sel_8 = document.querySelector('.s-8');
function f8() {
    let a = +sel_8.value
    switch (a) {
        case 1:
...
let inputIn_9 = document.querySelector('.i-9');
function f9() {
    let a = +inputIn_9.value;
    if (a >= 1 && a <= 32) {
...
function f10() {
    let a = +s_100.value;
    if (a == 6) {
        document.querySelector('.out-10').innerHTML = s_100.value;
    }
    else if (a == 7) {
        document.querySelector('.out-10').innerHTML = s_100.value;
    }
...
function f11() {
    let a = +s_110.value;
    if (a == 6) {
        document.querySelector('.out-11').innerHTML = s_110.value;
    } else if (a == 7) {
        document.querySelector('.out-11').innerHTML = s_110.value;
    }
    else if (a == 11) {
...
let inputIn_13 = document.querySelector('.i-130')
function f13() {
    let a = inputIn_13.value;
    document.querySelector('.out-13').innerHTML = (typeof a);
    //Потому что input принимает в строковом виде
}
...
let select_143 = document.querySelector('.s-143');
function f14() {
    let a = +i_141.value;
    let b = +i_142.value;
    let sel = select_143.value;
    if (sel == '+') {
...
let s_151 = document.querySelector('.s-151');
let s_152 = document.querySelector('.s-152');
let s_153 = document.querySelector('.s-153');
function f15() {
    let a = +s_151.value;
    let b = +s_152.value;
    let sel = s_153.value;
